...
// A hundred applications makes a hero. The squares beside a name and the rows
// that unfold beneath it stop there; the count beside the name does not.
const HUNDRED = 100;

export { REPO, GUIDE, HOME, HUNDRED };
