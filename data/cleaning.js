  ...
  try {
    ...
    while (checked < SAMPLE) {
      ...
      try {
        ...
        // is a Linux kernel is marked as such and kept. GitHub says its ten
        // seconds ran out in three ways: a 502, a 504, and an answer that
        // something went wrong, with an id to quote.
